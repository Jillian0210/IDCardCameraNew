...
import com.pengbo.idcardcamera.BuildConfig;
...
// 2022-01-20 pobo 需求
    public static final String EXTRA_CARD_TYPE = EXTRA_PREFIX + ".CardType";
    public static final String EXTRA_ID_CARD_FONT = EXTRA_PREFIX + ".IdCardFont";
    public static final String EXTRA_ID_CARD_BACK = EXTRA_PREFIX + ".IdCardBack";
    public static final String EXTRA_BANK_CARD = EXTRA_PREFIX + ".BankCard";
    ...
    public static class Options {
        ...
        /**
         * 2022-01-20 pobo 需求 身份证（正反面）、银行卡
         * @param cardType
         * @return
         */
        public void setCardType(int cardType) {
            mOptionBundle.putInt(EXTRA_CARD_TYPE,cardType);
        }
    }
